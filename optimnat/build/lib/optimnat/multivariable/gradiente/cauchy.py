...
def _gradiente(f, x, deltaX=0.001):
    """
    ...
    - deltaX (float, opcional): El tamaño del paso para la diferencia finita central. Por defecto, deltaX=0.001.
...
def cauchy(funcion, x0, epsilon1, epsilon2, M):
    """
    Método de Cauchy basado en gradiente para encontrar el mínimo de una función multidimensional.
    ...
    while not terminar:
        grad = np.array(_gradiente(funcion, xk))
